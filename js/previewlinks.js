(function () {
  document.addEventListener("DOMContentLoaded", () => {
    console.log("Preview links script is temporarily disabled for performance testing.");
    // All PDF generation and image fetching has been bypassed.
  });
})();
...
//   // --- PHASE 1: Set up the UI instantly ---
//   function setupUI() {
...
//       // Save references so we can add images to them later
//       anchor._previewElement = preview;
//       anchor._targetUrl = targetUrl;

//       // Add hover listeners immediately
...
//   // --- PHASE 2: Fetch the heavy assets in the background ---
//   function loadHeavyAssets() {
//     document.querySelectorAll("a.preview-link").forEach(anchor => {
//       const preview = anchor._previewElement;
//       const targetUrl = anchor._targetUrl;
      
//       if (!preview || !targetUrl) return;
...
//         // Use the free WordPress mshots API instead:
//         const thumbnailUrl = `https://s0.wordpress.com/mshots/v1/${encodeURIComponent(targetUrl)}?w=320`;
...
//   // Fire Phase 1 immediately so the HTML works
//   document.addEventListener("DOMContentLoaded", () => {
//     setupUI();
//   });

//   // Fire Phase 2 ONLY after the whole page (CSS, fonts, main images) is finished loading
//   window.addEventListener("load", () => {
//     // Add a 2-second delay so it doesn't interrupt your initial page transitions
//     setTimeout(() => {
//       loadHeavyAssets();
//     }, 2000);
//   });
